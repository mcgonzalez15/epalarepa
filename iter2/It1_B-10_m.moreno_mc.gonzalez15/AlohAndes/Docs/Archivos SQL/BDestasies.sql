...
CONSTRAINT CHECK_ID_VINCULO_CLIENT
CHECK(ID_VINCULO IN ('Estudiante','Hostal','Profesor','Hotel', 'Empleado','Fenicia','Profesor invitado','Registrado','Egresado','Padre estudiante','Vivienda universitaria' ))
);
...
ID_VINCULO VARCHAR(20) NOT NULL,
CONSTRAINT CHECK_ID_VINCULO_OPE
CHECK(ID_VINCULO IN ('Estudiante','Hostal','Profesor','Hotel', 'Empleado','Fenicia','Profesor invitado','Registrado','Egresado','Padre estudiante','Vivienda universitaria' ))
);
...
(
ID_SERVICIO NUMBER(6,0) NOT NULL,
ID_CLIENTE NUMBER(15,0) NOT NULL,
